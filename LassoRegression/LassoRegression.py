...
if __name__ == '__main__':
	...
	lasso_reg = Lasso(learning_rate = 1e-4, alpha = 10.0)
	...
	#Query Sample 1: [80]
	y_pred = lasso_reg.predict(np.array([[80]]))
	...
	lasso_reg = Lasso(learning_rate = 1e-7, alpha = 100.0)
	lasso_reg.fit(X_train, y_train)
	...
	#Query Sample 1:
	y_pred = lasso_reg.predict(np.array([[2012.667,5.6,90.45606,9,24.97433,121.5431]]))
	print("Predicted target is: {}".format(y_pred))